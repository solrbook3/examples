...
@Slow
public class SearchCommandTest extends CommandTestBase {
  ...
  public void testExecute() throws Exception {
    String solrUrl = cluster.getJettySolrRunners().get(0).getBaseUrl() + "/" + COLLECTION;
    String queryString = "SolrJ";

    Map<String, Object> attrs = new HashMap<String, Object>();
    attrs.put(SearchCommand.ARG_SOLR_URL_DEST, solrUrl);
    attrs.put(SearchCommand.ARG_QUERY_STRING_DEST, queryString);
  ...
  public void testExecuteSolrCloud() throws Exception {
    ...
    Map<String, Object> attrs = new HashMap<String, Object>();
    attrs.put(SearchCommand.ARG_ZOOKEEPER_HOST_DEST, zookeeperHost);
    attrs.put(SearchCommand.ARG_ZOOKEEPER_CHROOT_DEST, zookeeperChroot);
    attrs.put(SearchCommand.ARG_COLLECTION_DEST, collection);
    attrs.put(SearchCommand.ARG_QUERY_STRING_DEST, queryString);

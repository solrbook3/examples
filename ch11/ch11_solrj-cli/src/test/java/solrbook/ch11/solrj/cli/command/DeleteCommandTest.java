...
public class DeleteCommandTest extends CommandTestBase {
  ...
  public void testExecute() throws Exception {
    ...
    Map<String, Object> attrs = new HashMap<String, Object>();
    attrs.put(DeleteCommand.ARG_SOLR_URL_DEST, solrUrl);
    attrs.put(DeleteCommand.ARG_ID_DEST, id);
  ...
  public void testExecuteSolrCloud() throws Exception {
    ...
    Map<String, Object> attrs = new HashMap<String, Object>();
    attrs.put(DeleteCommand.ARG_ZOOKEEPER_HOST_DEST, zookeeperHost);
    attrs.put(DeleteCommand.ARG_ZOOKEEPER_CHROOT_DEST, zookeeperChroot);
    attrs.put(DeleteCommand.ARG_COLLECTION_DEST, collection);
    attrs.put(DeleteCommand.ARG_ID_DEST, id);
